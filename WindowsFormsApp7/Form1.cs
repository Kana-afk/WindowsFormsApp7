...
namespace WindowsFormsApp7
{
    public partial class Form1 : Form
    {
        ...
        {
            // set sorting
            // when sorting values 1 2 3 ... 10 11 12 are sorted as a string, that is, after 1 there will be values 10 11 12
   ...
   "Satisfactory", "Unsatisfactory"};
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            // if this value is not in the list, nothing happens
